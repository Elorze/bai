...
export default defineNuxtConfig({
  ...
  runtimeConfig: {
    public: {
      ...
      semiApiUrl: env.NUXT_PUBLIC_SEMI_API_URL || (nodeEnv === 'development' ? 'https://semi.fly.dev' : ''),
      semiOAuthUrl: env.NUXT_PUBLIC_SEMI_OAUTH_URL || (nodeEnv === 'development' ? 'http://www.semi.im' : ''),
